    ...
    <section className='c-space section-spacing' id='about'>
      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
        ...
        <div className='flex items-end grid-default-color grid-1'>
          ...
          />
          <div className='z-10'>
            <p className='headtext'>Hi, I'm Abde Ali</p>
            <p className='subtext'>
              Over the past three years, I’ve honed my frontend and backend
              development skills to build and deliver dynamic, high-performing
              web applications.
            </p>
          </div>
        ...
        <div className='grid-default-color grid-2'>
          ...
          >
            ...
            />
            <Card
              style={{ rotate: '-15deg', top: '25%', left: '25%' }}
              image='assets/logos/shopify.svg'
              containerRef={grid2Container}
            />
            <Card
              style={{ rotate: '5deg', top: '35%', left: '55%' }}
              image='assets/logos/chrome.svg'
              containerRef={grid2Container}
            />
          </div>
        </div>
